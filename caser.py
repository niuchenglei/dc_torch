...
class Caser(nn.Module):
    ...
    def __init__(self, num_users, num_items, model_args, nh=16, nv=4, drop_ratio=0.5, ac_conv='relu', ac_fc='relu'):
    ...
    def forward(self, seq_var, user_var, item_var, for_pred=False):
        ...
        #print("out_v shape: " + str(out_v.shape))
        #print("out_h shape: " + str(out_h.shape))
